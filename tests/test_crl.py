...
class TestCrl(unittest.TestCase):
    ...
    def test_add_none_to_old_crl(self
                                 ) -> None:
        """
        Create and sign a CRL with the key_label in the pkcs11 device.
        """
...
-----END X509 CRL-----"""
    ...
    def test_add_serial_to_empty_crl(self
                                     ) -> None:
        """
        Create and sign a CRL with the key_label in the pkcs11 device.
        """
        ...
        crl_pem = crl.create("test_3",
                             subject_name,
                             serial_number=2342342342343456,
                             reason=3)
    ...
    def test_add_serial_to_old_crl(self
                                   ) -> None:
        """
        Create and sign a CRL with the key_label in the pkcs11 device.
        """
